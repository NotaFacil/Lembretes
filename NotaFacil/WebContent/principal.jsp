      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          ...
          <form name="deslogar" method="POST" action="deslogar.do" class="navbar-form navbar-right">
            <input type="button" onclick="submit();" value="Sair" class="btn btn-primary"/>
          </form>
        </div>
      </div>
    </div>
      ...
      <div class="container">
      	<table>
      		<tr>
      			...
      			<td><h1>Lembretes</h1></td>
      		</tr>
      	</table>
      	<div class="row">
			<c:forEach var="lembrete" items="${listaLembretes}">
	        	<div class="col-lg-4">
				...
				<div class="window" id="janelaDetalhes${lembrete.id}">
					<div class="panel panel-default">
  						<div class="panel-body">
							<h2><strong>${lembrete.titulo}</strong></h2>
							<h5><i>criado em <fmt:formatDate pattern="dd/MM/yyyy HH:mm" value="${lembrete.dhCriacao}" /></i></h5>
							<ul class="list-group">
							...
							<div align="right">
								...
								<input type="button" onclick="frmExclusao${lembrete.id}.submit();" value="Excluir" class="btn btn-lg btn-danger"/>
								<form accept-charset="ISO-8859-1" name="frmExclusao${lembrete.id}" action="excluir.do" method="POST">
				...
				<div class="window" id="janelaAlteracao${lembrete.id}">
						...
						<div class="panel panel-default">
	  						<div class="panel-body">
								<div class="input-group input-group-lg">
									...
									<input type="text" class="form-control input-lg" placeholder="Título" name="titulo" value="${lembrete.titulo}">
								</div>
								...
								<ul class="list-group">
									<li class="list-group-item">
										<div class="input-group input-group-sm">
											...
											<textarea class="input-sm" rows="6" placeholder="Descrição" name="descricao" >${lembrete.descricao}</textarea>
										</div>
									</li>
									<li class="list-group-item">
										<div class="input-group input-group-sm">
											<span class="input-group-addon">Local</span>
											<input type="text" class="form-control input-sm" placeholder="Local" name="local" value="${lembrete.local}">
										</div>
									</li>
						            <li class="list-group-item">
										<div class="input-group date form_datetime" data-date="${dataHora}" data-date-format="dd/mm/yyyy hh:ii" data-link-field="dtp_input1">
											...
											<input type="text" ReadOnly="True" class="form-control" id="dh" placeholder="Início" value="<fmt:formatDate pattern="dd/MM/yyyy HH:mm" value="${lembrete.dhInicio}" />">
											<input type="hidden" name="dhInicio" value="<fmt:formatDate pattern="dd/MM/yyyy HH:mm" value="${lembrete.dhInicio}" />" />
						                </div>
						            </li>
						            <li class="list-group-item">
										<div class="input-group date form_datetime" data-date="${dataHora}" data-date-format="dd/mm/yyyy hh:ii" data-link-field="dtp_input1">
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<input type="text" ReadOnly="True" class="form-control" id="dh" placeholder="Fim" value="<fmt:formatDate pattern="dd/MM/yyyy HH:mm" value="${lembrete.dhFim}" />">
											<input type="hidden" name="dhFim" value="<fmt:formatDate pattern="dd/MM/yyyy HH:mm" value="${lembrete.dhFim}" />" />
						                </div>
						            </li>
								</ul>
								<input type="hidden" name="idLembrete" value="${lembrete.id}"/>
					...
					<div align="right">
						<input type="button" onclick="frmAlteracao${lembrete.id}.submit();" value="Ok" class="btn btn-lg btn-success"/>
					</div>
				</div>
			</c:forEach>						
		</div>
